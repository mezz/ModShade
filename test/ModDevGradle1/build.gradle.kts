...
base {
    archivesName.set("modshade-integration-moddevgradle1")
}
...
neoForge {
    ...
    mods {
        create("modshade_moddevgradle1_integration") {
...
val apiJar by tasks.registering(Jar::class) {
    group = "build"
    description = "Builds the ModDevGradle 1 public API jar without shaded implementation libraries."
...
tasks.register<JavaExec>("verifyIntegration") {
    ...
    mainClass.set("net.mezzdev.modshade.integration.VerifyModShadeArtifacts")
    args(
        "--diagnostic-jar", artifact("modshade-integration-moddevgradle1-1.0.0-unshaded.jar"),
        "--diagnostic-jar", artifact("modshade-integration-moddevgradle1-1.0.0-sources-unshaded.jar"),
        "--runtime-jar", artifact("modshade-integration-moddevgradle1-1.0.0.jar"),
        "--sources-jar", artifact("modshade-integration-moddevgradle1-1.0.0-sources.jar"),
        "--api-jar", artifact("modshade-integration-moddevgradle1-1.0.0-api.jar"),
        "--published-runtime-jar", publishedArtifact("modshade-integration-moddevgradle1-1.0.0.jar"),
        "--published-sources-jar", publishedArtifact("modshade-integration-moddevgradle1-1.0.0-sources.jar"),
        "--published-api-jar", publishedArtifact("modshade-integration-moddevgradle1-1.0.0-api.jar"),
        "--published-pom", publishedArtifact("modshade-integration-moddevgradle1-1.0.0.pom"),
        "--published-module", publishedArtifact("modshade-integration-moddevgradle1-1.0.0.module"),
        "--development-runtime-classpath-entry-prefix", "modshade-integration-library",
        ...
        "--required-module-artifact-file", "modshade-integration-moddevgradle1-1.0.0.jar",
        "--required-module-artifact-file", "modshade-integration-moddevgradle1-1.0.0-sources.jar",
