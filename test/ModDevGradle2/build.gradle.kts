...
base {
    archivesName.set("modshade-integration-moddevgradle")
}
...
neoForge {
    ...
    mods {
        create("modshade_moddevgradle_integration") {
...
val apiJar by tasks.registering(Jar::class) {
    group = "build"
    description = "Builds the NeoForge public API jar without shaded implementation libraries."
...
tasks.register<JavaExec>("verifyIntegration") {
    ...
    args(
        ...
        "--diagnostic-jar", artifact("modshade-integration-moddevgradle-1.0.0-sources-unshaded.jar"),
