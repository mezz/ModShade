...
tasks.register<JavaExec>("verifyIntegration") {
    ...
    args(
        ...
        "--published-runtime-jar", publishedArtifact("modshade-integration-moddevgradle-legacyforge-1.0.0.jar"),
        "--published-sources-jar", publishedArtifact("modshade-integration-moddevgradle-legacyforge-1.0.0-sources.jar"),
        "--published-api-jar", publishedArtifact("modshade-integration-moddevgradle-legacyforge-1.0.0-api.jar"),
        "--published-pom", publishedArtifact("modshade-integration-moddevgradle-legacyforge-1.0.0.pom"),
        "--published-module", publishedArtifact("modshade-integration-moddevgradle-legacyforge-1.0.0.module"),
        "--development-runtime-classpath-entry-prefix", "modshade-integration-library",
        ...
        "--required-module-artifact-file", "modshade-integration-moddevgradle-legacyforge-1.0.0.jar",
        "--required-module-artifact-file", "modshade-integration-moddevgradle-legacyforge-1.0.0-sources.jar",
