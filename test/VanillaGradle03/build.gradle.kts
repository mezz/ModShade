...
tasks.register<JavaExec>("verifyIntegration") {
    ...
    args(
        ...
        "--published-runtime-jar", publishedArtifact("modshade-integration-vanillagradle03-1.0.0.jar"),
        "--published-sources-jar", publishedArtifact("modshade-integration-vanillagradle03-1.0.0-sources.jar"),
        "--published-api-jar", publishedArtifact("modshade-integration-vanillagradle03-1.0.0-api.jar"),
        "--published-pom", publishedArtifact("modshade-integration-vanillagradle03-1.0.0.pom"),
        "--published-module", publishedArtifact("modshade-integration-vanillagradle03-1.0.0.module"),
        ...
        "--required-module-artifact-file", "modshade-integration-vanillagradle03-1.0.0.jar",
        "--required-module-artifact-file", "modshade-integration-vanillagradle03-1.0.0-sources.jar",
